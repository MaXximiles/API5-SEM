...
public interface EmpresaRepository extends JpaRepository<Empresa, Long>
{
	...
	@Query(value = "SELECT empresas.emp_id, emp_nome, empresas.cid_id,  empresas.cnae_id, emp_origem, emp_cnpj, cid_estado, cid_cidade, cid_regiaoibge "
			+ "	FROM empresas "
	...
	@Query(value = "SELECT empresas.emp_id, emp_nome, cid_id, empresas.cnae_id, cnae_codigo, cnae_descricao, emp_origem, emp_cnpj, cons_mes, cons_qtdconsumo "
			+ "	FROM empresas "
			+ " INNER JOIN cnae ON cnae.cnae_id = empresas.cnae_id "
	...
	@Query(value = "SELECT empresas.emp_id, emp_nome, empresas.cid_id, empresas.cnae_id, emp_origem, emp_cnpj,"
